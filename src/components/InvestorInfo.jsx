...
const InvestorInfo = () => {
  return (
    <SectionContainer anchorName="chudautu" style={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '10px' }}>
      <Row justify="center">
      ...
      <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: '16px', alignItems: 'center' }}>
        ...
        <div style={{ flex: '1', minWidth: '300px' }}>
          ...
          <Paragraph style={{ fontSize: '16px', lineHeight: '1.6', color: '#34495e' }}>
            Công ty Cổ phần Phát triển Thành Phố Xanh được thành lập vào ngày 23/11/2007, do Nguyễn Thực Hiền làm đại diện pháp luật. Công ty có trụ sở tại 72 Lê Thánh Tôn, phường Bến Nghé, Quận 1, TP. HCM.
          </Paragraph>
          <Paragraph style={{ fontSize: '16px', lineHeight: '1.6', color: '#34495e' }}>
