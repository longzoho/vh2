    ...
    <SectionContainer anchorName="daily" style={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '10px' }}>
      <Row justify="center">
        <Col span={24} style={{ textAlign: 'center' }}>
          <Title level={1} style={{ color: '#ff671c', marginBottom: '20px' }}>Chủ đầu tư CTCP Đầu tư Việt Phúc Holdings</Title>
        </Col>
      </Row>
      <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: '16px', alignItems: 'center' }}>
        <div style={{ flex: '0 0 auto', minWidth: '300px' }}>
          <Image
            src="investorInfo/cropped-logo.png"
            alt="Logo Việt Phúc Holdings"
            preview={false}
            style={{ width: '100%', maxWidth: '300px', objectFit: 'contain', borderRadius: '8px' }}
          />
        </div>
